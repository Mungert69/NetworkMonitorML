...
public sealed class TimesFmModelFactory : IMLModelFactory
{
    ...
    public TimesFmModelFactory(IRabbitRepo rabbitRepo, SystemParams systemParams, ILoggerFactory lf)
    {
    ...
    public IMLModel CreateModel(string modelType, int monitorPingInfoID, double confidence, int preTrain)
    {
        ...
        return new TimesFmRabbitModel(_rabbitRepo, _sys, log, monitorPingInfoID, confidence, preTrain, _routingKey);
    }
}
